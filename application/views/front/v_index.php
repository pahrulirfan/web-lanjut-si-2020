...
<head>
	...
	<link href="<?= base_url('assets/starbootstrap/') ?>css/styles.css" rel="stylesheet"/>
</head>
<body id="page-top">
<!-- Navigation-->
		...
		<div class="row justify-content-center">
			...
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
					...
					<img class="img-fluid" src="<?= base_url('assets/starbootstrap/') ?>assets/img/portfolio/cabin.png"
						 alt=""/>
				</div>
			</div>
			<!-- Portfolio Item 2-->
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal2">
					...
					<img class="img-fluid" src="<?= base_url('assets/starbootstrap/') ?>assets/img/portfolio/cake.png"
						 alt=""/>
				</div>
			</div>
			<!-- Portfolio Item 3-->
			<div class="col-md-6 col-lg-4 mb-5">
				<div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal3">
					...
					<img class="img-fluid" src="<?= base_url('assets/starbootstrap/') ?>assets/img/portfolio/circus.png"
						 alt=""/>
				</div>
			</div>
			<!-- Portfolio Item 4-->
			<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
				<div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal4">
					...
					<img class="img-fluid" src="<?= base_url('assets/starbootstrap/') ?>assets/img/portfolio/game.png"
						 alt=""/>
				</div>
			</div>
			<!-- Portfolio Item 5-->
			<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
				<div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal5">
					...
					<img class="img-fluid" src="<?= base_url('assets/starbootstrap/') ?>assets/img/portfolio/safe.png"
						 alt=""/>
				</div>
			</div>
			<!-- Portfolio Item 6-->
			<div class="col-md-6 col-lg-4">
				<div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal6">
					...
					<img class="img-fluid"
						 src="<?= base_url('assets/starbootstrap/') ?>assets/img/portfolio/submarine.png" alt=""/>
				</div>
			</div>
		</div>
	</div>
...
<section class="page-section bg-primary text-white mb-0" id="about">
	<div class="container">
		...
		<h2 class="page-section-heading text-center text-uppercase text-white">Data Mahasiswa</h2>
		<!-- Icon Divider-->
		<div class="divider-custom divider-light">
			<div class="divider-custom-line"></div>
			<div class="divider-custom-icon"><i class="fas fa-star"></i></div>
...
<!-- Contact form JS-->
<script src="<?= base_url('assets/starbootstrap/') ?>assets/mail/jqBootstrapValidation.js"></script>
<script src="<?= base_url('assets/starbootstrap/') ?>assets/mail/contact_me.js"></script>
<!-- Core theme JS-->
<script src="<?= base_url('assets/starbootstrap/') ?>js/scripts.js"></script>
</body>
</html>
